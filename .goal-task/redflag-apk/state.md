...
- [x] P7 review + re-review COMPLETE — verdict SHIP, no unresolved high-severity.
      N1 (NaN confidence) fixed post-re-review; 44/44 green after.
      (round 1 was: (10 findings; native receiver + deep link judged SHIP).
      ...
      smoke:realcall + smoke:ws re-PASS live. Re-review verdict: SHIP.)
